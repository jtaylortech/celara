...
class Checkpoint(BaseModel):
    ...
    synced_at: datetime = Field(default_factory=datetime.utcnow, description="Timestamp of last sync")
    ...
    class Config:
        ...
        json_schema_extra = {
            "example": {
                ...
                "last_synced_hash": "0x95b198e154acbfc64109dfd22d8224fe927fd8dfdedfae01587674482ba4baf3",
